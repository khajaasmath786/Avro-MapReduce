...
public class student_marks extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"student_marks\",\"namespace\":\"com.cts.avro\",\"fields\":[{\"name\":\"student_id\",\"type\":\"int\"},{\"name\":\"subject_id\",\"type\":\"int\"},{\"name\":\"marks\",\"type\":\"int\"}]}");
  ...
  public static com.cts.avro.student_marks.Builder newBuilder() {
    return new com.cts.avro.student_marks.Builder();
  }
  
  /** Creates a new student_marks RecordBuilder by copying an existing Builder */
  public static com.cts.avro.student_marks.Builder newBuilder(com.cts.avro.student_marks.Builder other) {
    return new com.cts.avro.student_marks.Builder(other);
  }
  
  /** Creates a new student_marks RecordBuilder by copying an existing student_marks instance */
  public static com.cts.avro.student_marks.Builder newBuilder(com.cts.avro.student_marks other) {
    return new com.cts.avro.student_marks.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<student_marks>
    ...
    private Builder() {
      super(com.cts.avro.student_marks.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cts.avro.student_marks.Builder other) {
      super(other);
    ...
    private Builder(com.cts.avro.student_marks other) {
            super(com.cts.avro.student_marks.SCHEMA$);
      if (isValidValue(fields()[0], other.student_id)) {
        this.student_id = data().deepCopy(fields()[0].schema(), other.student_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'student_id' field */
    public com.cts.avro.student_marks.Builder setStudentId(int value) {
    ...
    public com.cts.avro.student_marks.Builder clearStudentId() {
    ...
    /** Sets the value of the 'subject_id' field */
    public com.cts.avro.student_marks.Builder setSubjectId(int value) {
    ...
    public com.cts.avro.student_marks.Builder clearSubjectId() {
    ...
    /** Sets the value of the 'marks' field */
    public com.cts.avro.student_marks.Builder setMarks(int value) {
    ...
    public com.cts.avro.student_marks.Builder clearMarks() {
